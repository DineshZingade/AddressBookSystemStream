package com.bridgelabz.UC12sortAddressBookByStateCityZip;
...
public class AddressBook {
	...
	public void sortByZip() {
		referenceBook.stream().sorted((contact1, contact2) -> contact1.getPinCode() - contact2.getPinCode())
				.forEach(System.out::println);
	}

	public void sortByCity() {
		referenceBook.stream().sorted((contact1, contact2) -> contact1.getCity().compareTo(contact2.getCity()))
				.forEach(System.out::println);
	}

	public void sortByState() {
		referenceBook.stream().sorted((contact1, contact2) -> contact1.getState().compareTo(contact2.getState()))
				.forEach(System.out::println);
	}
